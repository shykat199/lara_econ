(function () {
    ...
    if (localStorage.mamixrtl) {
        ...
        document.querySelector("#style")?.setAttribute("href", "https://laravelui.spruko.com/mamix/build/assets/libs/bootstrap/css/bootstrap.rtl.min.css");
            // rtlFn();
    }
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "https://laravelui.spruko.com/mamix/build/assets/libs/bootstrap/css/bootstrap.min.css");
    }
